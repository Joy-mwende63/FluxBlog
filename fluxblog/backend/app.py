...
@jwt_required()  # Ensure the user is logged in to create a post
def create_post():
    data = request.get_json()
...
@jwt_required()  # Ensure the user is logged in to like a post
...
@jwt_required()  # Ensure the user is logged in to comment on a post
...
def unauthorized(error):
    return jsonify({"message": "Unauthorized access, please provide a valid token."}), 401
